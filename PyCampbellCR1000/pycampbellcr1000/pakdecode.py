...
class PakBusDecode(object):
    ...
    def __init__(self, link, security_code=0x0000):
        self.link = link        
    ...
    def decode_packet(self, data):
        ...
        if len(data) < 8:
            LOGGER.error('Not enough bytes to decode (need 8)')
        else:
